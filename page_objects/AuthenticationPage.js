...
function AuthenticationPage() {
  ...
  this.createAnAccountButton = element(by.class('icon-user left'));
  this.emailCreateAccountField = element(by.class('is_required validate account_input form-control'));
  ...
  this.addressFistNameField = element(by.xpath('//input[@id='firstname']'));
